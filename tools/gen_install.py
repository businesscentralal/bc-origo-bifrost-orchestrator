...
and writes app/src/Install/NornirTakeover.Codeunit.al. Every table pair, field list and enum
...
OUT = os.path.join(SRC, "Install", "NornirTakeover.Codeunit.al")
...
def gen():
    ...
    a("/// </summary>")
    a('codeunit %d "Nornir Takeover ori"' % TAKEOVER_ID)
    a("{")
    a("    Access = Internal;")
    a("")
    a("    /// <summary>")
